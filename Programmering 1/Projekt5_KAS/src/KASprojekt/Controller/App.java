...
public class App {
    public static void main(String[] args) {
        ...
        Deltager d1 = Controller.createDeltager("Finn Madsen", "blob", "blob", "null", "null", "22243532");
        ...
        Controller.createTilmelding(LocalDate.of(2024, 12, 18),
                LocalDate.of(2024, 12, 20), false, null, d2, h1, test, new ArrayList<>(), k1);
...
//        for (Tilmelding tilmelding : k1.getTilmeldinger()) {
//            System.out.println(tilmelding.getPrice());
//        }
        Controller.eksporterUdflugter(k2);
